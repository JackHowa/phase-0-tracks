...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/bunkrich/F46MF16UV/secret_agents.rb?nojsmode=1" /></noscript>
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U3RU68D89");
							sb('set', 'user_' + "batch", "?");
							sb('set', 'user_' + "created", "2017-01-17");
						sb('set', 'name_tag', "dbc-phase0" + '/' + "jack-howard");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>secret_agents.rb | Phase 0 Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/f6e6/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/ac27/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://avatars.slack-edge.com/2017-01-17/127935471472_fb1aef19115086ba9adc_192.jpg')" data-thumb-size="48" data-member-id="U3RU68D89"></span>
					<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-01-17/127935471472_fb1aef19115086ba9adc_72.jpg')" data-thumb-size="36" data-member-id="U3RU68D89"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">jack-howard</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/18058388231?crumb=s-1487275990-7f7b688056-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://dbc-phase0.slack.com/home" target="https://dbc-phase0.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            				                            		<i class="team_icon small" style="background-image: url('https://s3-us-west-2.amazonaws.com/slack-files2/avatars/2016-01-08/18088820547_b53da861921b9637c635_88.jpg');"></i>
		                            		                            		<span class="switcher_label team_name">Phase 0</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	...
	Created by bunkrich on Thursday, February 16, 2017 at  2:12 PM
	</strong><br />
	<span class="subtle_silver break_word">https://dbc-phase0.slack.com/files/bunkrich/F46MF16UV/secret_agents.rb</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T0J1QBE6T-F46MF16UV-beee6d3f60" target="new">https://slack-files.com/T0J1QBE6T-F46MF16UV-beee6d3f60</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		2KB Ruby snippet created on <span class="date">February 16, 2017</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents"># caesar cipher 
...
<form action="https://dbc-phase0.slack.com/files/bunkrich/F46MF16UV/secret_agents.rb"
		id="file_comment_form"
					class="comment_form clearfix"
				method="post">
			<a href="/team/jack-howard" class="member_preview_link" data-member-id="U3RU68D89" >
			<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-01-17/127935471472_fb1aef19115086ba9adc_72.jpg')" data-thumb-size="36" data-member-id="U3RU68D89"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1487275990-2d62a13b11-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U3RU68D89',
		no_login: false,
		version_ts: '1487275476',
		version_uid: '2c8622717508239ebf29dd96d1d83d9d81c317fe',
		...
		feature_message_replies_ignore_on_history: true,
		...
		feature_sso_expose_signed_elements: false,
		...
		feature_shared_channels_boot: false,
		...
		feature_react_emoji_picker_on_webpages: false,
		...
		feature_app_cards_app_label: true,
...
//-->
	...
	<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/e26ed/js/rollup-core_required_libs.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/ed4d6/js/rollup-core_required_ts.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/fae01/js/rollup-core_web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bfdf2/js/rollup-secondary_a_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/fe27/js/rollup-secondary_b_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/aa6d/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<script type="text/javascript">
				TS.clog.setTeam('T0J1QBE6T');
				TS.clog.setUser('U3RU68D89');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F46MF16UV","created":1487275964,"timestamp":1487275964,"name":"secret_agents.rb","title":"secret_agents.rb","mimetype":"text\/plain","filetype":"ruby","pretty_type":"Ruby","user":"U3TNXMD2M","editable":true,"size":1642,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T0J1QBE6T-F46MF16UV\/secret_agents.rb","url_private_download":"https:\/\/files.slack.com\/files-pri\/T0J1QBE6T-F46MF16UV\/download\/secret_agents.rb","permalink":"https:\/\/dbc-phase0.slack.com\/files\/bunkrich\/F46MF16UV\/secret_agents.rb","permalink_public":"https:\/\/slack-files.com\/T0J1QBE6T-F46MF16UV-beee6d3f60","edit_link":"https:\/\/dbc-phase0.slack.com\/files\/bunkrich\/F46MF16UV\/secret_agents.rb\/edit","preview":"# caesar cipher \n\n\n=begin\nmessage = \"abcdefghijklmnopqrstuvwxyz\"","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E# caesar cipher \u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E=begin\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003Emessage = &quot;abcdefghijklmnopqrstuvwxyz&quot;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":89,"lines_more":84,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D45SF8DK3"],"comments_count":0};
...
<!-- slack-www-hhvm-0208a2e6c55cbf2a1 / 2017-02-16 12:13:10 / v2c8622717508239ebf29dd96d1d83d9d81c317fe / B:H -->
